...
NOTE: This action is deprecated since version 2.4.x. Please use the link:../generic-button/GenericButton.adoc[Generic Button.adoc] action. _Deprecated_ means, that this action will not receive any new features, but it will still be supported, and it will not be removed.

...
/// <summary>
/// Holds an (observable) expression as a string as well as optionally the NCalc expression object (if the string is valid) and
/// a list of the parameter names used in the expression.
/// </summary>
